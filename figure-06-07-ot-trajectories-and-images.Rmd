...
## Read 3 digitally partnered images generated above to annotate them.
if (! is.null(getOption("knitr.in.progress"))) {
  ...
  dir_fig_suppl <-
    file.path("_bookdown_files",
              "figure-06-07-ot-trajectories-and-images_files",
              "figure-html")
}
samples <- c(33L, 17L, 57L)
