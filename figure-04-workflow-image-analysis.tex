...
\begin{preview}
  \begin{tikzpicture}[
    ...
    anchor = north, yshift = -2em] {pairwise, etc.};
    ...
    text width = {width("generated images")}, xshift = -2mm]
    {Input images and \textit{generated} images};
    ...
    [arr, -{Stealth[fill = black, length = 10pt, width = 15pt, sep = 1pt]}];
    \node [draw, dotted, fit = (fit-im) (lbl-m), inner sep = 0.2pt] {};
    \node [draw, dotted, fit = (lbl-gran) (im-t-ch-3) (im-t-ch-4-5),
    inner sep = 1pt] {};
